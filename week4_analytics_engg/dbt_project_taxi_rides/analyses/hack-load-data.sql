<<<<<<< HEAD
-- MAKE SURE YOU REPLACE dataengg-zoomcamp WITH THE NAME OF YOUR DATASET! 
...
CREATE TABLE  `dataengg-zoomcamp.trips_data_all.green_tripdata` as
SELECT * FROM `bigquery-public-data.new_york_taxi_trips.tlc_green_trips_2019`; 


CREATE TABLE  `dataengg-zoomcamp.trips_data_all.yellow_tripdata` as
SELECT * FROM `bigquery-public-data.new_york_taxi_trips.tlc_yellow_trips_2019`;

insert into  `dataengg-zoomcamp.trips_data_all.green_tripdata` 
SELECT * FROM `bigquery-public-data.new_york_taxi_trips.tlc_green_trips_2020` ;


insert into  `dataengg-zoomcamp.trips_data_all.yellow_tripdata` 
SELECT * FROM `bigquery-public-data.new_york_taxi_trips.tlc_yellow_trips_2020`; 

  -- Fixes yellow table schema
ALTER TABLE `dataengg-zoomcamp.trips_data_all.yellow_tripdata`
...
ALTER TABLE `dataengg-zoomcamp.trips_data_all.green_tripdata`
  RENAME COLUMN vendor_id TO VendorID;
ALTER TABLE `dataengg-zoomcamp.trips_data_all.green_tripdata`
...
ALTER TABLE `taxi-rides-ny-339813-412521.trips_data_all.green_tripdata`
  RENAME COLUMN dropoff_location_id TO DOLocationID;
>>>>>>> cd5185c07cb9957ab4f17bd15bb10e720dd32790
